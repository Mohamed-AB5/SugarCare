package com.example.sugarcare.app.ui.theme

import androidx.compose.ui.graphics.Color

// ── Core brand colors ─────────────────────────────────────────
val TealPrimary     = Color(0xFF2E9B9B)
val TealPrimary2    = Color(0xFF1F8B8B)
val TealDark        = Color(0xFF1F7A7A)
val TealLight       = Color(0xFFB2DFDB)

val GreenAccent     = Color(0xFF5BAD6F)
val GreenAccent2    = Color(0xFF4A9D62)
val GreenAccent3    = Color(0xFF3D8F55)

val OrangeDrop      = Color(0xFFE87A3E)
val OrangeDrop2     = Color(0xFFFFEED4C8)
