package com.example.sugercare.core.features.meals.localData
...
object LocalMealData {
    ...
    fun getDoctorMealPlan(): List<DoctorMeal> = listOf(
        ...
        DoctorMeal(
            ...
            suggestedFoods = listOf(
                "Grilled chicken breast", "Romaine lettuce",
    ...
    fun getMealSuggestions(): List<MealSuggestion> = listOf(
        ...
        MealSuggestion(
            ...
            category = "Lunch",
            ingredients = listOf(
                "Ground turkey", "Lettuce leaves", "Garlic",
        ...
        MealSuggestion(
            ...
            category = "Dinner",
            ingredients = listOf(
                "Chicken breast", "Broccoli", "Snap peas",
        ...
        MealSuggestion(
            ...
            category = "Dinner",
            ingredients = listOf(
                "Cauliflower rice", "Black beans", "Avocado",
                "Salsa", "Lime juice"
            ),
            calories = 320,
            carbsGrams = 30,
